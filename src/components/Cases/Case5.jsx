...
import Case5Content from "../../assets/defaultCaseData.json";
import CaseAccordian from "../Accordians/CaseAccordian";

const CaseComponent5 = ({ searchTerm, tNumber, cl }) => {
  useEffect(() => {
    searchText();
  }, [searchTerm]);
  const [isClicked, setClicked] = useState(false);
  const caseContent = Case5Content[4];
