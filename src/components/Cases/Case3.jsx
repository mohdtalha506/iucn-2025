...
import Case3Content from "../../assets/defaultCaseData.json";
import CaseAccordian from "../Accordians/CaseAccordian";

const CaseComponent3 = ({ searchTerm , tNumber, cl}) => {
  useEffect(() => {
    searchText();
  }, [searchTerm]);
  const [isClicked, setClicked] = useState(false);
  const caseContent = Case3Content[2];
