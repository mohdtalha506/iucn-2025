...
import Case6Content from "../../assets/defaultCaseData.json";
import CaseAccordian from "../Accordians/CaseAccordian";

const CaseComponent6 = ({ searchTerm, tNumber, cl }) => {
  useEffect(() => {
    searchText();
  }, [searchTerm]);
  const [isClicked, setClicked] = useState(false);
  const caseContent = Case6Content[5];
